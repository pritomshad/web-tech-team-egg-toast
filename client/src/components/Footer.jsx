      ...
      <div className={`${!loggedIn && 'max-w-7xl'} mx-auto px-4 lg:px-8`}>
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between border-t-2 border-gray-300/30 dark:border-gray-700 gap-8">
          ...
          <p className="text-sm text-center sm:text-left flex items-center">
            ...
            <Link to="https://github.com/2021331056m" className='mx-1 hover:underline underline-offset-4'>Maliha</Link>,
            <Link to="https://github.com/pritomshad" className='mx-1 hover:underline underline-offset-4'>Pritom</Link>,
            <Link to="https://github.com/JACsadi" className='mx-1 hover:underline underline-offset-4'>Jawad</Link>
